...
public class CeldaTo implements Comparable<CeldaTo> {
    ...
    private VerticalAlignment alinearVerticalmente;
    private HorizontalAlignment alinearHorizontalmente;
    ...
    private FillPatternType patronRelleno;
    private String colorBordesHexadecimal;
    private BorderStyle estiloBorde;
